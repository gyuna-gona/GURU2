...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var btnInit : Button;          lateinit var btnInsert : Button
    lateinit var btnModify : Button;        lateinit var btnDelete : Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnModify.setOnClickListener {
            sqlDB = myHelper.writableDatabase
            sqlDB.execSQL("UPDATE groupTest SET gNumber = " + edtNumber.text + " WHERE gName = '"
                                + edtName.text.toString() + "';")
            sqlDB.close()
            btnSelect.callOnClick()
        }
        ...
        btnDelete.setOnClickListener {
            sqlDB = myHelper.writableDatabase
            sqlDB.execSQL("DELETE FROM groupTest WHERE gName= '" + edtName.text.toString() + "';")
            sqlDB.close()
            btnSelect.callOnClick()
        }
